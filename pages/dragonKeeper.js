          ...
          <div className={style.section}>
            ...
            <div className="flex flex-col items-center w-11/12 p-2 border-t-2 border-b-2 border-primary">
              ...
              <div className="w-full mt-2 text-justify bg-white">
                <p>
                  Dragonkeeper es la primera película de animación coproducida
                  entre España y China, con el apoyo español de Antena 3 y
                  Telefónica, distribuida en España por Contacorriente, una de
                  las mayores distribuidoras del país.
                </p>
                <p>
                  Basada en el primer libro de la colección Dragonkeeper de
                  Carol Wilkinson, best seller internacional y dirigida por el
                  galardonado director español Salvador Simó.
                </p>
                <p>
                  Dragonkeeper cuenta una historia que transcurre durante la
                  dinastía Han en la antigua China. Ping es una joven niña que
                  vive como esclava en una remota fortaleza y en las mazmorras
                  de esa fortaleza se custodian a los últimos Dragones
                  imperiales.
                </p>
                <p>
                  Ping ayudará a escapar a Danzi ,el último dragón, y recuperará
                  el huevo de dragón de las manos del enfermo emperador y su
                  malvado consejero Diao. Esta historia es un viaje donde Ping
                  conocerá su poder interior y aceptará su destino como la
                  última cuidadora de dragones … los llamados Dragonkeepers.
                </p>
              </div>
            </div>
          </div>
