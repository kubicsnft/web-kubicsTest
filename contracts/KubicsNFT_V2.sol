    ...
    ReentrancyGuard
{
    ...
    address public constant WHITELIST_CONTRACT =
        0x0813d4a158d06784FDB48323344896B2B1aa0F85;
    // Despliegue en Rinkeby:  0x902cD155FBdaD5e8D0135eb7Cd0A9237Ef75d497
    // Despliegue en ETH: 0x9B399A856B0016Cf91c60aaAE195B33738874C2B
    ...
    //Constructor
    constructor() ERC721("Kubics_V2", "KBC") {
        //Setting accounts
        i_owner = msg.sender;
    ...
    function payToMintA(string memory metadataURI)
        ...
        returns (uint256)
    {
        //Checking all conditionals before executing the Mint
        if (mintStatus != true) {
    ...
    function setWhitelistPriceCollectionA(uint256 whitelistNewPriceA)
        public
        onlyOwner
    {
        //Set the new price in Wei!
    ...
    function setWhitelistPriceCollectionB(uint256 whitelistNewPriceB)
        public
        onlyOwner
    {
        //Set the new price in Wei!
    ...
    function setWhitelistPriceCollectionC(uint256 whitelistNewPriceC)
        public
        onlyOwner
    {
        //Set the new price in Wei!
    ...
    function setWhitelistPriceCollectionD(uint256 whitelistNewPriceD)
        public
        onlyOwner
    {
        //Set the new price in Wei!
    ...
    function setWhitelistPriceCollectionE(uint256 whitelistNewPriceE)
        public
        onlyOwner
    {
        //Set the new price in Wei!
